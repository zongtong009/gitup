...
# 生成主界面
window = tk.Tk()
window.title('高数计算器---BY:Java_S')
window.geometry('640x640')
window.geometry("640x640+450+90")
window.wm_resizable(False, False)

# TOP图片
canvas = tk.Canvas(window, bg="white", height=200, width=640)
image_file = tk.PhotoImage(file="bg.png")
image = canvas.create_image(0, 0, anchor="nw", image=image_file)
canvas.pack()

# 操作手册图片
canvas1 = tk.Canvas(window, bg="white", height=340, width=636)
image_file1 = tk.PhotoImage(file="start.png")
...
button_ans = tk.Button(window, text="点我计算", bd=1, font=("Microsoft YaHei", 12), activebackground='Light green',
                       command=play)
# -------------方程组---------------
...
button_ans_lim = tk.Button(window, text="点我计算", bd=1, font=("Microsoft YaHei", 12), activebackground='Light green',
                           command=lim_play)
...
d_num_ans = tk.Button(window, text="点我计算", bd=1, font=("Microsoft YaHei", 12), activebackground='Light green',
                      command=play_d_num)
# -------------求导数---------------
...
pd_num_ans = tk.Button(window, text="点我计算", bd=1, font=("Microsoft YaHei", 12), activebackground='Light green',
                       command=play_pd_num)
# -------------求偏导数---------------
...
din_num_ans = tk.Button(window, text="点我计算", bd=1, font=("Microsoft YaHei", 12), activebackground='Light green',
                        command=play_din)
# -------------求定积分---------------
...
bdin_num_ans = tk.Button(window, text="点我计算", bd=1, font=("Microsoft YaHei", 12), activebackground='Light green',
                         command=play_bdin)
# -------------求不定积分---------------
...
button_fun = tk.Button(window, text="解方程", font=("Microsoft YaHei", 12), activebackground='Light green', bg="#fc9d9a",
                       command=func)
button_lim = tk.Button(window, text="求极限", font=("Microsoft YaHei", 12), activebackground='Light green', bg="#fc9d9a",
                       command=lim)
button_der = tk.Button(window, text="求导数", font=("Microsoft YaHei", 12), activebackground='Light green', bg="#fc9d9a",
                       command=d_n)
button_par = tk.Button(window, text="求偏导", font=("Microsoft YaHei", 12), activebackground='Light green', bg="#fc9d9a",
                       command=pd_n)
button_itg = tk.Button(window, text="求定积分", font=("Microsoft YaHei", 12), activebackground='Light green', bg="#fc9d9a",
                       command=din)
button_bitg = tk.Button(window, text="求不定积分", font=("Microsoft YaHei", 12), activebackground='Light green',
                        bg="#fc9d9a", command=b_din)
